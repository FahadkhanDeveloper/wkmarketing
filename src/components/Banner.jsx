...
const Banner = () => {
  return (
    <div className='px-4 py-32 bg-white-500 shadow-md mx-auto'>
        <div className='text-black text-center'>
            <h1 className='text-5xl lg:text-3xl loading-snug font-bold mb-5'>Welcome To The WK <span className='text-orange-600'>Marketing</span></h1>
                            {/* w-3/5  means 60% width */}
